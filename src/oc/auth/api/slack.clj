  ...
  (if-let* [slack-response (when-not (or error (false? (first response))) response)
      ...
      (let [;; Get the existing slack org if present
            ...
            jwt-user (user-rep/jwt-props-for (-> updated-slack-user
                                              ...
                                              :slack)]
        (timbre/info "DBG existing-slack-org" existing-slack-org)
        (timbre/info "DBG existing-user" existing-user)
        (timbre/info "DBG _error" _error)
        (timbre/info "DBG user-profile" user-profile)
        (timbre/info "DBG target-team" target-team)
        (timbre/info "DBG slack-team-info" slack-team-info)
        (timbre/info "DBG updated-slack-team-info" updated-slack-team-info)
        (timbre/info "DBG slack-org" slack-org)
        (timbre/info "DBG cleaned-user-props" cleaned-user-props)
        (timbre/info "DBG new-user" new-user)
        (timbre/info "DBG relevant-teams" relevant-teams)
        (timbre/info "DBG new-team" new-team)
        (timbre/info "DBG teams" teams)
        (timbre/info "DBG existing-team-ids" existing-team-ids)
        (timbre/info "DBG relevant-team-ids" relevant-team-ids)
        (timbre/info "DBG additional-team-ids" additional-team-ids)
        (timbre/info "DBG updated-user" updated-user)
        (timbre/info "DBG user" user)
        (timbre/info "DBG new-slack-user" new-slack-user)
        (timbre/info "DBG bot-only?" bot-only?)
        (timbre/info "DBG redirect-arg" redirect-arg)
        (timbre/info "DBG slack-user-u" slack-user-u)
        (timbre/info "DBG slack-user-digest" slack-user-digest)
        (timbre/info "DBG updated-slack-user" updated-slack-user)
        (timbre/info "DBG jwt-user" jwt-user)
